  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 bg-black">
        <div className="absolute inset-0 bg-gradient-to-br from-red-900/10 via-black to-blue-900/10" />
        <div className="absolute inset-0 bg-grid-pattern opacity-20" />
        <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent" />
      </div>

      {/* Navigation */}
      <nav className="relative z-50 flex items-center justify-between px-6 py-4 border-b border-red-500/20 backdrop-blur-sm">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <a href="#how" className="text-gray-300 hover:text-red-400 transition-colors">How It Works</a>
          <a href="#stats" className="text-gray-300 hover:text-red-400 transition-colors">Statistics</a>
          <a href="#partners" className="text-gray-300 hover:text-red-400 transition-colors">Partners</a>
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* BugHunter Card */}
            <Card className="bg-black/60 border-red-500/30 hover:border-red-500 transition-all duration-300 group hover:scale-105">
            ...
            {/* Organization Card */}
            <Card className="bg-black/60 border-blue-500/30 hover:border-blue-500 transition-all duration-300 group hover:scale-105">
              <CardContent className="p-8 text-center">
                <div className="mb-6 relative">
            ...
            {/* Admin Portal Card */}
            <Card className="bg-black/60 border-green-500/30 hover:border-green-500 transition-all duration-300 group hover:scale-105">
              <CardContent className="p-8 text-center">
                <div className="mb-6 relative">
